...
(define *shift-tests* '(((value .  8) (shift .  2) (result . 32))
                        ((value .  4) (shift .  0) (result .  4))
                        ((value .  8) (shift . -1) (result .  4))
...
(define *bit-count-tests* `(((value .  0) (result . 0))
                            ...
                            ((value . ,(expt 2 100))          (result . 1))
                            ((value . ,(- (expt 2 100)))      (result . 100))
                            ((value . ,(- (1+ (expt 2 100)))) (result . 1))))
...
(define *bitwise-if-tests*
  '(((mask . 3) (n0 . 1) (n1 . 8) (result . 9))
    ((mask . 3) (n0 . 8) (n1 . 1) (result . 0))
    ((mask . 1) (n0 . 1) (n1 . 2) (result . 3))
    ((mask   . #b00111100)
     (n0     . #b11110000)
     (n1     . #b00001111)
     (result . #b00110011))))
